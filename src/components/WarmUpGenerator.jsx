    ...
    return (
        <div>
            ...
            <button 
                ...
                style={{ fontWeight: boldButton === 'three' ? 'bold' : 'normal', border: boldButton === 'three' ? '5px solid black' : 'none' }}
            >
            ...
            <button 
                ...
                style={{ fontWeight: boldButton === 'four' ? 'bold' : 'normal', border: boldButton === 'four' ? '5px solid black' : 'none' }}
            >
            ...
            <button 
                ...
                style={{ fontWeight: boldButton === 'five' ? 'bold' : 'normal', border: boldButton === 'five' ? '5px solid black' : 'none' }}
            >
