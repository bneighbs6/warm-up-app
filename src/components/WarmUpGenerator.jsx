...
function WarmUpGenerator() {
    ...
    return (
        <div>
            ...
            <button onClick={handleThreeRandomize}>Randomize a 3x3 Warm Up</button>
            <button onClick={handleFourRandomize}>Randomize a 3x4 Warm Up</button>
            <button onClick={handleFiveRandomize}>Randomize a 3x5 Warm Up</button>
